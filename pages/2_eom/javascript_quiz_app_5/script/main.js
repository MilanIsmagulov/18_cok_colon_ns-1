...
let mainQuestions = [
    {
        text: 'Укажите, каким образом поддерживается температура верха колонны:',
        right: [0],
        type: 1,
        points: 100,
        answers: ['путем подачи орошения в верхнюю часть колонны', 'путем изменения расхода сырья', 'увеличением отбора фракции','изменением мощности работы вентилятора воздушного холодильника'],
    },
];
